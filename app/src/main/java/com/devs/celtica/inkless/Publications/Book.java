...
public class Book extends Publication {
    ...
    //this contruct for uploading to BD Sqlite .. just for using the methode GetDataBook 12/08/2019 BY cosanostra
    public Book(String nom1, String nom2, String photo, String lien) {

        this.nom1 = nom1;
        this.nom2 = nom2;
        this.lien_resume = lien;
        this.photo = photo;
    }
